...
#url_token = 'https://twitter.com/'
#url_token = ' https://twitter.com/i/api/1.1/branch/init.json'
"""headers = {
...
if __name__ == "__main__":
    #token = requests.post(url_token, headers=headers).text
    #token = requests.get(url_token).headers
